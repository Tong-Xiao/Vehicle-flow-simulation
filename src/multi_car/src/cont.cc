...
namespace gazebo
{
    ...
    void CatSteering::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
    {
        ...
        */
        ...
        this->ros_spinner_thread_ = boost::thread( boost::bind( &CatSteering::fire_truckSimROSThread, this ) );
    } //end Load

    void CatSteering::fire_truckSimROSThread()
    {
